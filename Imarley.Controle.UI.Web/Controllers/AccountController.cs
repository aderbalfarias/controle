...
using Imarley.Controle.Security.Identity;
using Imarley.Controle.Security.Models;
using Imarley.Controle.UI.Web.ViewModels.Identity;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirme sua Conta", "Por favor confirme sua conta clicando neste link: <a href='" + callbackUrl + "'>" + callbackUrl + "</a>");
